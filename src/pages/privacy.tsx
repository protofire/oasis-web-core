...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'Oasis Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using {'Oasis Safe'}</h4>
    <p>
      When visiting our website or using {'Oasis Safe'}, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the {'Oasis Safe'}, we process your
        <ol>
    ...
    <p>
      In addition, we may take a recording of you while testing {'Oasis Safe'} for internal and external use. The basis
    ...
    <p>
      {'Oasis Safe'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'Oasis Safe'} mobile app via biometrics information (touch ID or face ID). This
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Oasis Safe`}. For enhanced
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'Oasis Safe – Privacy policy'}</title>
      </Head>
