...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <p>
      In addition, we may take a recording of you while testing {'Oasis Safe'} for internal and external use. The
    ...
    <p>
      We enable the user to unlock the {'Oasis Safe'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Oasis Safe`}. For
