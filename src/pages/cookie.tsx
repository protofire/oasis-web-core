...
const SafeCookiePolicy = () => (
  <div>
    ...
    <p>
      This Cookie Policy applies to our{' '}
      <Link href="/" passHref legacyBehavior>
        <MUILink>website</MUILink>
      </Link>{' '}
    ...
    <ol>
      ...
      <li>Third-party cookies stored by a different domain than the visited page&apos;s domain.</li>
    </ol>

    <h2>What cookies do we use and why?</h2>
    <p>We list all the cookies we use on this website in the APPENDIX below.</p>
    <p>
      We do not use cookies set by ourselves via our web developers (first-party cookies). We only use those set by
    ...
    <ol>
      <li>
        ...
        to see how visitors move around our website when they are using it, as well as dates and times they visit. This
        helps us to improve the way our website works, for example, by ensuring that users are finding what they are
        looking for easily.
      </li>
      <li>
        <strong>Targeting cookies:</strong> These cookies record your visit to our website, the pages you have visited
        and the links you have followed, as well as time spent on our website, and the websites visited just before and
        just after our website. We will use this information to make our website and the advertising displayed on it
    ...
    <p>
      <strong>Pixels tags.</strong> Pixel tags (which are also called clear GIFs, web beacons, or pixels) are small
      pieces of code that can be embedded on websites and emails. Pixels tags may be used to learn how you interact with
      our website pages and emails, and this information helps us and our partners provide you with a more tailored
      experience.
    </p>
    <p>
      <strong>Device Identifiers.</strong> A device identifier is a unique label that can be used to identify a mobile
      device. Device identifiers may be used to track, analyze, and improve the performance of the website and ads
      delivered.
    </p>
    ...
    <ol>
      ...
      <li>Improve the speed of the site when you access content repeatedly;</li>
    ...
    <p>
      ...
      <Link href="https://www.google.com/analytics/#?modal_active=none" passHref legacyBehavior>
      ...
      information about your device, such as time of visit, pages visited, time spent on each page of our website, links
      clicked and conversion information, IP address, browser, mobile network information, and type of operating system
      used.
    </p>
    ...
    <p>
      ...
      changes, such as by sending an email notification, providing notice through our website, or updating the ‘Last
      Updated’ date at the beginning of this Cookie Policy. The amended Cookie Policy will be effective immediately
      after the date it is posted. By continuing to access or use our website after the effective date, you confirm your
      acceptance of the revised Cookie Policy and all of the terms incorporated therein by reference. We encourage you
      to review our Privacy Policy and our Cookie Policy whenever you access or use our website to stay informed about
    ...
    <p>
      ...
      indicated, are not affiliated or associated with us. Your exercise of any rights to opt-out may also impact how
      our information and content is displayed and/or accessible to you on this website and on other websites.
    </p>
  </div>
)
...
const CookiePolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'Oasis Safe – Cookie policy'}</title>
      </Head>
