...
const descriptionText = 'Oasis Safe is the most trusted platform to manage digital assets on Oasis Sapphire networks.'
const titleText = 'Oasis Safe'
...
const MetaTags = ({ prefetchUrl }: { prefetchUrl: string }) => (
  <>
    ...
    {/* Social sharing */}
    <meta name="og:image" content="https://safe.oasis.io/images/social-share.png" />
    <meta name="og:description" content={descriptionText} />
    <meta name="og:title" content={titleText} />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@OasisProtocol" />
    <meta name="twitter:title" content={titleText} />
    <meta name="twitter:description" content={descriptionText} />
    <meta name="twitter:image" content="https://safe.oasis.io/images/social-share.png" />
