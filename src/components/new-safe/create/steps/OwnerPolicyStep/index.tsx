        ...
        <Box className={layoutCss.row}>
          ...
          {/* <Box p={2} mt={3} sx={{ backgroundColor: 'background.main', borderRadius: '8px' }}>
            <Typography variant="subtitle1" fontWeight={700} display="inline-flex" alignItems="center" gap={1}>
              {'Oasis Safe'} mobile signer key (optional){' '}
              <Tooltip
                title="The Oasis Safe mobile app allows for the generation of signer keys that you can add to this or an existing Safe Account."
                arrow
                placement="top"
              >
